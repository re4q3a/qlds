...
class myessentials(iouonegirlPlugin):
    ...
    def cmd_help(self, player, msg, channel):
        ...
        player.tell("^1======= ^7welcome to ^2Pisiont Gr ^7server ^1=======\n^5callvote options:^7\n^3/callvote do ^7vote to force team balance if recommended by !teams\n^3/callvote spec <id> ^7vote to move player with <id> to spectators\n^3/callvote tempban <id> ^7vote to kickban player with <id> until the current game ends\n^3/players ^7find out player id: <id> <steamID> <nickname>\n^5commands:\n^3!sounds ^7disable/enable sound triggers\n^3!off/!on <trigger> ^7disable/enable sound for <trigger>\n^3!listmaps ^7list available custom maps\n^3!listsounds ^7list available sounds\n^1============================================^7\n")
        return minqlx.RET_STOP_ALL
